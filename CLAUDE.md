...
- `src/components/`: `Cabecalho.tsx` (painéis logados); `PainelDisponibilidade.tsx` (edição/replicar disponibilidade, compartilhado entre `barbeiro/page.tsx` e `admin/page.tsx` — mesma entidade, mesmo dono/barbeiro logado nos dois casos).
